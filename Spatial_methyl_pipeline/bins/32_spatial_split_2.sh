#!/bin/sh
usage="sh <script.sh> <sample_name> <queue> <ppn> <mem> <thread> <part> <column> <split>"
...
#PBS -e ${Output_path}/split2_${part}_${k}_${name}.err
#PBS -o ${Output_path}/split2_${part}_${k}_${name}.out
#HSCHED -s hschedd
#PPN limit ${ppn}
...
dsub ${name}_${part}_${k}_split2.sh
